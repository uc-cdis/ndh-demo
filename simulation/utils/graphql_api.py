...
def download_data(fileid, auth, api_url):

   api_url = api_url + 'user/data/download/'
   file_url = requests.get(api_url+fileid, headers={'Authorization': 'bearer '+ auth.json()['access_token']}).text
